    ...
    <UserCoursesProvider taiKhoan={taiKhoan as string}>
      <div className="min-h-screen pt-5">
        ...
        <div className="mt-6 flex justify-center">
          <div
            className="min-h-100 w-full scroll-target overflow-x-auto rounded-container border border-border-subtle bg-bg-default shadow-surface select-none md:max-w-130"
            ref={scrollRef}
          >
            <UserCoursesTable />
          </div>
