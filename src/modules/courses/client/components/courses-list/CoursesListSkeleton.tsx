...
export const CoursesListSkeleton = () => (
  <article className="flex h-109 flex-col overflow-hidden rounded-container border border-border-default bg-bg-default shadow-surface select-none md:h-120">
    <Skeleton fullWidth />
