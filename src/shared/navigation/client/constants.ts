...
export type ClientRouteBuilderKey =
  (typeof CLIENT_ROUTE_BUILDERS_KEYS)[keyof typeof CLIENT_ROUTE_BUILDERS_KEYS];
...
export const CLIENT_ROUTE_BUILDERS_PATHS = {
  ...
  [CLIENT_ROUTE_BUILDERS_KEYS.COURSES_BY_CATEGORY]: "category/:maDanhMuc",
} as const;
...
export const CLIENT_ROUTE_BUILDERS_TITLES = {
  ...
  [CLIENT_ROUTE_BUILDERS_KEYS.COURSES_BY_CATEGORY]: "Courses By Category",
} as const;
...
export const CLIENT_ROUTE_BUILDERS = {
  ...
  [CLIENT_ROUTE_BUILDERS_KEYS.COURSES_BY_CATEGORY]: (maDanhMuc: string) =>
